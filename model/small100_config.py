...
class Small100Config(PretrainedConfig):
    r"""
...
class Small100OnnxConfig(OnnxSeq2SeqConfigWithPast):
    @property
...
__all__ = ["Small100Config", "Small100OnnxConfig"]