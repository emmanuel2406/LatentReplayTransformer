...
VOCAB_FILES_NAMES = {
    "vocab_file": "small_100/vocab.json",
    "spm_file": "small_100/sentencepiece.bpe.model",
    "tokenizer_config_file": "small_100/tokenizer_config.json",
}
...
class SMALL100Tokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        spm_file=vocab_files_names["spm_file"],
        tgt_lang=None,
        bos_token="<s>",
        eos_token="</s>",
        sep_token="</s>",
        ...
        **kwargs,
        ...
        # self.vocab_size = len(self.encoder) + len(self.lang_token_to_id) + self.num_madeup_words
        super().__init__(
            tgt_lang=tgt_lang,
            bos_token=bos_token,
            eos_token=eos_token,
    ...
    def get_vocab(self) -> Dict:
        ...
        vocab = {self.convert_ids_to_tokens(i): i for i in range(1000)}
